...
public class ApplicationPermitListReportModel extends AsyncReportController {
    ...
    String title = "Application Listing (By Permit Issuance)";
    ...
    def formControl = [
        getControlList: { 
            return [
                ...
                [type:'checklist', caption:'App Type', name:'entity.apptypes', immediate:true, preferredSize:'0,30', items:'appTypeList', itemExpression:'#{item.title}', selectionMode:'MULTIPLE', itemCount:3, captionWidth:130 ],
